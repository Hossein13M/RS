...
export const navigation: FuseNavigation[] = [
        ...
        children: [
            {
                ...
                type: 'item',
                icon: 'business',
                url: '/organizations-structure/organizations-list',
            },
    ...
    },
    {
        ...
        children: [
            ...
            {
                id: 'contractCardboard',
                title: 'کارتابل قرارداد',
                type: 'item',
                icon: 'dashboard',
                url: '/contract/cardboard',
            },
        ],
    },
        ...
        children: [
            {
                ...
                url: '/risk-measurement/yield_curve',
            },
            {
                id: 'assets_return',
                title: 'بازده ریسک و دارایی ها',
                type: 'item',
                icon: 'assignment_return',
                url: '/risk-measurement/assets_return',
            },
            {
                id: 'risk_measuring',
                title: 'اندازه گیری ریسک',
                type: 'item',
                icon: 'straighten',
                url: '/risk-measurement/risk_measuring',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                type: 'item',
                icon: 'dashboard',
                url: '/system-settings/input',
            },
            {
                id: 'instrumentsInfo',
                title: 'ورود اطلاعات ابزارها',
                type: 'item',
                icon: 'dashboard',
                url: '/system-settings/bourse',
            },
            ...
            { id: 'gl', type: 'item', url: '/system-settings/gl', title: 'نگاشت کد دفتر کل', icon: 'subject' },
            {
                id: 'deposit',
                type: 'item',
                url: '/system-settings/deposit',
                title: 'ورود اطلاعات سپرده',
                icon: 'subject',
            },
            { id: 'bank', type: 'item', url: '/system-settings/bank', title: 'لیست بانک‌ها', icon: 'subject' },
            {
                id: 'bourse-board',
                type: 'item',
                url: '/system-settings/bourse-board',
                title: 'لیست تابلوهای بورسی',
                icon: 'subject',
            },
            {
                id: 'bourse-market',
                type: 'item',
                url: '/system-settings/bourse-market',
                title: 'لیست بازارهای بورسی',
                icon: 'subject',
            },
            {
                id: 'instrument',
                type: 'item',
                url: '/system-settings/instrument',
                title: 'لیست ابزار‌ها',
                icon: 'subject',
            },
            ...
            { id: 'supervisor', type: 'item', url: '/system-settings/supervisor', title: 'لیست ناظر', icon: 'subject' },
            {
                id: 'organizationType',
                type: 'item',
                url: '/system-settings/organization-type',
                title: 'لیست نوع نهاد',
                icon: 'subject',
            },
            {
                id: 'instrumentType',
                type: 'item',
                url: '/system-settings/instrument-type',
                title: 'لیست نوع اوراق',
                icon: 'subject',
            },
            { id: 'fund', type: 'item', url: '/system-settings/fund', title: 'لیست مشخصات صندوق', icon: 'subject' },
            {
                id: 'market',
                type: 'item',
                url: '/system-settings/market',
                title: 'لیست اطلاعات بازار',
                icon: 'subject',
            },
        ],
    },
