...
@Injectable()
export class TradeDashboardService extends Specification {
    ...
    getTradeTable(fc?: FormContainer): Observable<any> {
        let url = TradeDashboardService.TradeAPI + '/categorized-assets?date=' + this.convertDate(this.searchForm.value.date);
