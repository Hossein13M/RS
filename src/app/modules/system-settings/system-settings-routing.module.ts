...
const routes: Routes = [
    ...
    { component: DepositSettingListComponent, path: 'deposit' },
    { component: BankSettingListComponent, path: 'bank' },
    { component: BourseBoardSettingListComponent, path: 'bourse-board' },
    { component: BourseMarketSettingListComponent, path: 'bourse-market' },
    { component: InstrumentSettingListComponent, path: 'instrument' },
    { component: OrganizationSupervisorListComponent, path: 'supervisor' },
    { component: OrganizationTypeSettingListComponent, path: 'organization-type' },
    { component: FundRoleSettingListComponent, path: 'fundRole' },
    { component: InstrumentTypeSettingListComponent, path: 'instrument-type' },
    { component: FundSettingListComponent, path: 'fund' },
    { component: MarketSettingListComponent, path: 'market' },
    { component: InputComponent, path: 'input' },
    { component: BourceInstrumentDetailComponent, path: 'bourse' },
];
