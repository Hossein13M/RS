...
import { FundListDto, RsponceComplianceCalculatedDto } from 'app/services/API/models';
import { CompliancesCalculatedService } from 'app/services/App/compliance/complianceCalculated/compliance-calculated.service';
...
export class CalculatedComplianceComponent implements OnInit, OnDestroy {
    ...
    constructor(private calculatedService: CompliancesCalculatedService, private zone: NgZone) {
