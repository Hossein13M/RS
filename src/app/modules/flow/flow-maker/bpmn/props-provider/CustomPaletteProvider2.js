 ...
 */
export default function CustomPaletteProvider2(palette, create, elementFactory, spaceTool, lassoTool, handTool, globalConnect, translate) {
...
CustomPaletteProvider2.prototype.getPaletteEntries = function (element) {
    var actions = {},
        create = this._create,
